...
const renderLlmsIndex = (catalog: MockosManagementDocumentationCatalog): string =>
  [
    ...
    "  Messages/model subsets, including SSE, are source-qualified locally; state/reset,",
    "  observations, Anthropic betas, configured midstream errors, Cloud pinning, and",
    "  deployment remain unavailable or unqualified.",
