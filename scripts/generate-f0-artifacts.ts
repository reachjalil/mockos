...
const renderManagementTools = (
  ...
  const lines = [
    ...
    "",
    `Status: Generated from the implemented ${catalog.managementMcp.toolCount}-tool management registry; F1 mock MCP and bounded F2 OpenAI/Anthropic data planes are source-qualified locally`,
...
const renderLlmsIndex = (catalog: MockosManagementDocumentationCatalog): string =>
  [
    ...
    "  its bounded OpenAI- or Anthropic-shaped non-streaming provider data plane.",
    ...
    "  Messages/model subsets are source-qualified locally; state/reset, observations,",
    "  streaming/betas, Cloud pinning, and deployment remain unavailable or unqualified.",
