...
Status: Generated from the implemented 24-tool management registry; F1 mock MCP, bounded streaming OpenAI, and bounded non-streaming Anthropic data planes are source-qualified locally
...
- Anthropic streaming, beta APIs, OpenAI Responses, durable conversation state,
  configured mid-stream errors, observations/assertions, Cloud pinning,
...
- OpenAI Responses, Anthropic streaming/betas, durable conversations, and
