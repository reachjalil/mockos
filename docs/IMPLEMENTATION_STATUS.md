...
Status: M0-M3 and tested M5 accepted; bounded M6 has sampled deployed evidence; M7 and F0 foundations are source-complete locally pending hosted CI/merge
