...
Status: M0-M3 and tested M5 accepted; bounded M6 deployed; M7/F0 source-complete; F1 locally source-qualified
...
this document: the focused suites and complete repository gate are green. Hosted CI,
merge, package publication, deployment, private Cloud integration, F2-F3 runtimes, F4
authorization/audit, broader client/ecosystem conformance, and F6 Code Mode activation
remain pending.
