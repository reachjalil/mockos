...
Status: M0-M3 and tested M5 accepted; bounded M6 has sampled deployed evidence; M7/F0 are source-complete and F1 foundation is locally partial
...
The [F1 foundation](./f-series/f1-mcp-foundation.md) adds locally tested contracts,
