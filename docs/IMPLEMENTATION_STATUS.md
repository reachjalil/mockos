...
Anthropic JSON/SSE Messages through pinned official SDKs. Both auth modes require
...
OpenAI Responses, Anthropic betas, runtime/conversation state or reset, LLM
